    ...
    <>
      ...
      <main className="max-w-7xl mx-auto py-6 px-4">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Deep insights into your job search progress</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{loading ? '...' : analyticsData?.summary?.total_applications || 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{loading ? '...' : analyticsData?.summary?.current_streak || 0} days</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{loading ? '...' : analyticsData?.summary?.interview_rate || 0}%</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{loading ? '...' : analyticsData?.summary?.applications_this_week || 0}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          {/* Success Funnel */}
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Success Funnel</h3>
                  ...
                  return (
                    <div key={status}>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-semibold">{numCount} ({percentage.toFixed(1)}%)</span>
                      </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">{loading ? '...' : analyticsData?.summary?.interview_rate || 0}%</span>
              </div>
              <div className="flex justify-between">
        ...
        {/* Weekly Progress */}
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Current Week Progress</h3>
          <div className="text-center py-8">
            <div className="text-4xl font-bold text-blue-600 mb-2">
              {loading ? '...' : analyticsData?.summary?.applications_this_week || 0}
            </div>
            <div className="text-gray-600 mb-4">applications this week</div>
